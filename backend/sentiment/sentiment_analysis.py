...
class SentimentAnalysis:
    def __init__(self):
        # load data
        print('Loading data...')
        with open(CONFIG.word_set_path, 'rb') as f:
            self.word_set = pickle.load(f)
        with open(CONFIG.word_embedding_path, 'rb') as f:
            self.word_embedding = pickle.load(f)
        with open(CONFIG.knowledge_base_path, 'rb') as f:
        ...
        # load model
        print('Loading model...')
        self.model_PAIR = torch.load(CONFIG.model_PAIR_path)
        self.model_SENT = torch.load(CONFIG.model_SENT_path)
